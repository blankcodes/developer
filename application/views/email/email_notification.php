...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Email Notification - <?=$siteSettings['website_name']?></title>
								...
								<table class="flexible" width="600" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
									<tr>
										<td class="" style="padding-bottom: 10px; padding-top: 20px;"> 
											<!-- <a href="<?=$header_image_url?>"><img src="<?=$header_image?>" style="width: 280px; height: auto;" alt="<?=$siteSettings['website_name']?>"></a> -->
										</td>
									</tr>
									<tr>
											...
											<table width="100%" cellpadding="0" cellspacing="0" style="position: relative;">
												...
												<tr>
													<td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;"  style="font:normal 16px/26px Poppins, Helvetica, sans-serif; color:#363636; padding:0 0 20px;">
														...
														<div style="padding-bottom: 20px; padding-top: 10px; width: 400px; color: #363636; font-size: 14px; font-weight: 500;">A new message from the <?=$siteSettings['website_name']?> using cron job!</div>

														
														<div style="padding-top: 20px; color: #000;">
															Regards,<br>
															<?=$siteSettings['website_name']?> Team<br>
														</div>
													</td>
												</tr>
														...
														<table width="100%" cellpadding="0" cellspacing="0">
															<tr>
																<td data-color="text" data-link-color="link text color" data-link-style="text-decoration:underline; color:#797c82;" class="aligncenter" style="font:12px/16px Arial, Helvetica, sans-serif; color:#797c82; padding:0 0 10px;">
																	&copy; <?=date('Y')?> <?=$siteSettings['website_name']?>. All Rights Reserved. 
																</td>
															</tr>
														</table>
													</th>
